...
export default {
  ...
  computed: {
    postres() {
      return recetas.filter(r => r.categoria === 'postres')
    }
  }
}
</script>
...
<template>
  <div class="postres-container">
    <h2 class="titulo-seccion">Descubre nuestros deliciosos postres</h2>
    
    <div class="cards-container">
      <div v-for="receta in postres" :key="receta.id" class="card">
...
/* Estado cuando no hay postres */
.cards-container:empty::after {
    content: "No hay postres disponibles";
    text-align: center;
    color: #5a3e1b;
    font-size: 1.1rem;
    padding: 3rem;
